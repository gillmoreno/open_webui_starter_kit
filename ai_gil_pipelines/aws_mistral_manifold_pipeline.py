...
class Pipeline:
    ...
    def pipe(
        ...
        try:
            ...
            system_prompt = f"<s>[INST] {system_message}\n\n" if system_message else ""

            # Combine the system prompt with the processed messages and the user message
            prompt = system_prompt + processed_messages + f"<|user|>\n\n{user_message}\n[/INST]"
